export const courses = [{ name: "MTH 104  Fundamentals of Algebra and Trigonometry. (2 h)" },
			...
			{ name: "MTH 251  Ordinary Differential Equations. (3 h)" },
			...
			{ name: "Science I. (3 h)" },
			{ name: "Science II. (3 h)" },
			{ name: "STA 107  Explorations in Statistics. (3 h)" },
			{ name: "STA 111  Elementary Probability and Statistics. (4 h)" },
			{ name: "STA 112  Introduction to Regression and Data Science. (3 h)" },
			{ name: "STA 175  Competitions. (1 h)" },
			{ name: "STA 214  Applied Generalized Linear Models. (3 h)" },
			{ name: "STA 247  Design and Sampling. (3 h)" },
			{ name: "STA 279  Topics in Statistics. (3 h)" },
			{ name: "STA 310  Probability. (3 h)" },
			{ name: "STA 311  Statistical Inference. (3 h)" },
			{ name: "STA 312  Linear Models. (3 h)" },
			{ name: "STA 352  Networks: Models and Analysis. (3 h)" },
			{ name: "STA 362  Multivariate Statistics. (3 h)" },
			{ name: "STA 363  Introduction to Statistical Learning. (3 h)" },
			{ name: "STA 364  Computational and Nonparametric Statistics. (3 h)" },
			{ name: "STA 365  Applied Bayesian Statistics. (3 h)" },
			{ name: "STA 368  Time Series and Forecasting. (3 h)" },
			{ name: "STA 379  Advanced Topics in Statistics. (3 h)" },
			{ name: "STA 381  Applied Statistics Capstone. (2 h)" },
			{ name: "STA 382  Applied Statistics Capstone. (1.5 h)" },
			{ name: "STA 383  Individual Study. (1 h)" },
			{ name: "STA 391  Honors Research I. (1 h)" },
			{ name: "STA 392  Honors Research II. (1 h)" },
